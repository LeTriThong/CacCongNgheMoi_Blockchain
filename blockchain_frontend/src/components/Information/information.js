            ...
            <div>
                <div className="Info-card-container">
                    ...
                    <div className="Info-card-network">
                        ...
                        <div className="Info-card-text">
                            ...
                            <div className="Info-card-content">
                                <label className="Info-card-content">Difficulty: {getDifficulty()}</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ display: 'flex' }}>
                    ...
                    <div style={{ display: 'flex', flex: 1, flexDirection: 'column', marginLeft: '20px' }}>
                        <div className="Info-send-transaction-container">
                            <label className="Info-send-transaction">Latest block</label>
                        </div>
                        {
                            blockchain.slice(0, 10).map(e => {
                                if (e.index !== 0) {
                                    return cloneElement(<BlockInfo blockInfo={e} />)
                                }
                                else {
                                    return <div/>;
                                }
